...
\def\setupcover{%
  \dodoubleargument\dosetupcover}
\def\dosetupcover[#1][#2]{%
  \getparameters[\csname ??thu#1\endcsname][#2]}
...
\def\makeencover{%
  ...
  \startalignment [center]
    ...
    \stoplines
 Dissertation Supervisor: \@@thuensupervisor\par
 Associate Supervisor: \@@thuenassupervisor\par
...
\def\makeauthorization{%
  ...
  作者签名：\underbar{\hbox to 5em{}}  导师签名：
  日   期：   日   期：
  \stopalignment
  \stopstandardmakeup}
