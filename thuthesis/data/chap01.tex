...
\begin{table}[h]
  ...
  \begin{minipage}[t]{0.565\textwidth} 
    \begin{tabular*}{\linewidth}{|r|c|c|c|c|}
      \hline
    ...
    \end{tabular*}\\[2pt]
    \dawu[1.3] 注：数据来源《\thuthesis{} 使用手册》。\\
    *：东部\\
    **：西部
  \end{minipage}
\end{table}

虽然~\LaTeX{} 的表格功能没有想象中的那么强大，只要你足够认真，足够细致，那么同样
可以排出来非常复杂非常漂亮的表格。请参看表~\ref{tab:tabexamp2}（未用三线表）。
\begin{table}[h]
  \centering
  \caption{复杂表格示例~2。}
  \label{tab:tabexamp2}
...
如果您要排版的表格超过一页，那么推荐使用~\texttt{longtable} 或者
